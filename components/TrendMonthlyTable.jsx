...
const API_URL = process.env.NEXT_PUBLIC_COMPLAINTS_TREND_URL;

const COLUMNS = [
  { key: 'Sr No',                                label: <>Sr No</> },
  { key: 'Month',                                label: <>Month</> },
  { key: 'Carried Forward from previous month',  label: <>Carried Forward</> },
  { key: 'Received',                             label: <>Received</> },
  { key: 'Resolved*',                            label: <>Resolved<sup>*</sup></> },
  { key: 'Pending#',                             label: <>Pending<sup>#</sup></> },
];

export default function TrendMonthlyTable() {
  ...
  return (
    <div
      ...
      tabIndex={0}
      role="region"
      aria-label="Trend of monthly disposal of complaints (scrollable)"
    >
      <table className="w-full text-sm font-sans border-collapse min-w-[600px]">
        <caption className="sr-only">Trend of monthly disposal of complaints</caption>
