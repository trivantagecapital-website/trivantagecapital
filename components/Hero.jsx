    ...
    <section className="relative w-full pt-32 pb-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 lg:px-10">
        <div className="max-w-[900px]">
          <h1
            className="!font-serif text-white text-5xl md:text-6xl lg:text-7xl leading-[1.1] mb-6 ">
          ...
          <div
            className="space-y-6 text-base md:text-md text-white leading-relaxed font-light max-w-[800px]">
            <p>
